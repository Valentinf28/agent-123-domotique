...
function Automations({ dossierId, items, setModal, notify, selectAutomation, setEnabled, requestHomeRefresh }: {
  ...
  return <div className="content coach-page">
    ...
    <details className="coach-detail coach-automation-detail" open={assistantBusy || Boolean(assistantPreview)}><summary><span><b>Créer une automatisation</b><small>Décrivez la règle, vérifiez son aperçu, puis confirmez</small></span><i>⌄</i></summary><section className="automation-assistant" id="assistant-domotique" aria-label="Assistant de création d’automatisations">
      <header>
