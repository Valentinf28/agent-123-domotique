...
import { measuredFiltrationEnergyToday, measuredVehicleEnergyToday, measuredVehicleEnergyYesterday } from "../lib/measured-vehicle-energy";
...
test("calcule séparément l'énergie envoyée à la voiture hier", () => {
  const result = measuredVehicleEnergyYesterday([
    { capturedAt: "2026-08-09T10:00:00+02:00", vehicleWatts: 3_000 },
    { capturedAt: "2026-08-09T10:10:00+02:00", vehicleWatts: 3_000 },
    { capturedAt: "2026-08-10T10:00:00+02:00", vehicleWatts: 7_000 },
    { capturedAt: "2026-08-10T10:10:00+02:00", vehicleWatts: 7_000 },
  ], new Date("2026-08-10T12:00:00+02:00"));
